...
class Model_patient_effective_date extends MY_Model {
	...
	private $primary_key 	= 'PATIENT_AUTONO';
	private $table_name 	= 'patient_effective_date';
	private $field_search 	= ['PATIENT_AUTONO', 'PATIENT_EFFECTIVE_NO', 'ORIGINAL_TERM_DATE', 'START_DATE', 'TERM_DATE', 'STATUS', 'EXTEND', 'REMARK'];
