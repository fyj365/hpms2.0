...
<section class="content-header">
    <h1>
        Diagnosis Code        <small>New Diagnosis Code</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Diagnosis Code</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8" style="margin-bottom: 15px;">
                               ...
                               <input type="txt" name="DIAG_CODE" list="code_list" class="cust-required form-control">

                              <datalist id="code_list">
                                <?php if ($diagnosis_code_counts >0) {
                                  foreach ($diagnosis_codes as $diagnosis_code) {; ?>
                                    <option value="<?php echo $diagnosis_code->DIAG_CODE;?>"><?php echo $diagnosis_code->DIAG_CODE;?></option>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="cust-required form-control" name="DIAG_CODE_STANDARD" id="DIAG_CODE_STANDARD" value="<?= set_value('DIAG_CODE_STANDARD'); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="E_DESC" name="E_DESC" rows="5" class="textarea"><?= set_value('E_DESC'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/diagnosis_code/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
