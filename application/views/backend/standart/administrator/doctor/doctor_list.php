...
<section class="content">
   <div class="row" >
               ...
               <div class="box box-widget">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <div class="row pull-right">
                       ...
                       <h4>Total: <i class="label bg-yellow"><?= $doctor_counts; ?>  items</i></h4>
     ...
     <form name="form_doctor" id="form_doctor" action="<?= base_url('administrator/doctor/index'); ?>">
         <div class="row">
            <div class="col-sm-8">
               <button type="submit" class="btn btn-default Multiple_F" name="cust_sbtn" id="cust_sbtn" value="Apply" title="filter search"> Filter  </button> 
      ...
      <table class="table table-bordered dataTable my-table">
         ...
         <tbody id="tbody_doctor">
          ...
          <tr data-href='<?= site_url('administrator/doctor/view/' . $doctor->d_DR_CODE); ?>'>
                           <td class="clickable-row"><?= _ent($doctor->d_CARD_CODE); ?><br></td> 
