...
<section class="content-header">
    <h1>
       COMPANY <small>Edit <?= $company->E_NAME;?></small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row" >
        <div class="col-md-12">
            ...
            <!--     <li class="nav-item">
             ...
             <div id="home">
                        <div id="company" class="col-sm-12">
                                <div class="form-group ">
                            <label for="COM_ID" class="col-sm-2 control-label">COMPANY ID
                            </label>
                            <div class="col-sm-4">
                                 <input type="text" class="form-control" name="COM_ID" value="<?= set_value('COM_ID', $company->COM_ID); ?>" readonly>
                            </div>
                         ...
                         <?php if ($BP_STATUS !=false){
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="C_E_NAME" value="<?= set_value('C_E_NAME', $company->E_NAME); ?>">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="C_C_NAME" value="<?= set_value('C_C_NAME', $company->C_NAME); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="SURGICAL_RATING"  value="<?= set_value('SURGICAL_RATING', $company->SURGICAL_RATING); ?>">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control pull-right datepicker" name="JOIN_DATE" id="JOIN_DATE" value="<?= set_value('company_JOIN_DATE_name', $company->JOIN_DATE); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="BILLING_DEPT_NAME" value="<?= set_value('BILLING_DEPT_NAME', $company->BILLING_DEPT_NAME); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-4">
                             ...
                             <input type="text" class="form-control" name="DIAG_CODE_STANDARD" id="DIAG_CODE_STANDARD" maxlength='80' list="Diagnosis_code" value="<?= set_value('DIAG_CODE_STANDARD', $company->DIAG_CODE_STANDARD); ?>">
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_ADDR1" value="<?= set_value('E_ADDR1', $company->E_ADDR1); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_ADDR2" value="<?= set_value('E_ADDR2', $company->E_ADDR2); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div> 
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_ADDR3" value="<?= set_value('E_ADDR3', $company->E_ADDR3); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_ADDR4" value="<?= set_value('E_ADDR4', $company->E_ADDR4); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_ADDR5" value="<?= set_value('E_ADDR5', $company->E_ADDR5); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="E_DISTRICT"  value="<?= set_value('E_DISTRICT', $company->E_DISTRICT); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_ADDR1"  value="<?= set_value('C_ADDR1', $company->C_ADDR1); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_ADDR2"  value="<?= set_value('C_ADDR2', $company->C_ADDR2); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_ADDR3"  value="<?= set_value('C_ADDR3', $company->C_ADDR3); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_ADDR4"  value="<?= set_value('C_ADDR4', $company->C_ADDR4); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_ADDR5" value="<?= set_value('C_ADDR5', $company->C_ADDR5); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="C_DISTRICT"  value="<?= set_value('C_DISTRICT', $company->C_DISTRICT); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                ...
                <div id="contact">
                     <?php 
                              $i=0;
                             if ($com_contacts) {
                             foreach ($com_contacts as $com_contact){?>
                              <div class="col-sm-4">
                                     <div class="form-group ">
                            <label for="CONTACT_NO" class="col-sm-4 control-label">Contact No
                            </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="CONTACT_NO[]" value="<?= $com_contact->CONTACT_NO;?>" readonly>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="Contact_E_NAME[]"   value="<?= $com_contact->E_NAME;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="Contact_C_NAME[]" value="<?= $com_contact->C_NAME;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="TITLE[]" value="<?= $com_contact->TITLE;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="DEPARTMENT[]"  value="<?= $com_contact->DEPARTMENT;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="TEL[]" value="<?= $com_contact->TEL;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="FAX[]"  value="<?= $com_contact->FAX;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <input type="email" class="form-control" name="EMAIL[]"  value="<?= $com_contact->EMAIL;?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
