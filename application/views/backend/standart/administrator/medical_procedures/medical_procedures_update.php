...
<section class="content-header">
    <h1>
        Medical Procedures        <small>Edit Medical Procedures</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Medical Procedures</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/medical_procedures/edit_save/'.$this->uri->segment(4)), [
						   ...
						   <div class="col-sm-8 cust-required-select">
							  <select class="form-control chosen chosen-select-deselect" name="SP_CODE">
								 ...
								 <?php 
									...
									?>
								 <option <?= $row->SP_CODE == $medical_procedures->SP_CODE ? "selected" : ""; ?> value="<?= $row->SP_CODE ?>"><?= $row->C_DESC; ?> &nbsp; <?= $row->E_DESC; ?></option>
								 <?php endforeach; ?>  
							  </select>
							...
							<div class="form-group ">
							   ...
							   <div class="col-sm-8">
								  <input type="text" class="form-control cust-required" name="CLINIC_PROCEDURE" id="CLINIC_PROCEDURE" value="<?= set_value('CLINIC_PROCEDURE', $medical_procedures->CLINIC_PROCEDURE); ?>">
								  <small class="info help-block">
								  </small>
							   </div>
							</div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_medical_procedures.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#medical_procedures_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
