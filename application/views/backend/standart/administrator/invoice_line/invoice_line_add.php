...
<section class="content-header">
    <h1>
        Invoice Line        <small>New Invoice Line</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Invoice Line</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="INVOICE_NO" id="INVOICE_NO" placeholder="INVOICE NO" value="<?= set_value('INVOICE_NO'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BATCH_NO" id="BATCH_NO" placeholder="BATCH NO" value="<?= set_value('BATCH_NO'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/invoice_line/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
