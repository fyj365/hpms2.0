                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
						   ...
						   <div class="form-group ">
							  <label for="TEL" class="col-sm-2 control-label">Tel  <i class="required">*</i>
							  </label>

							  <div class="col-sm-3">
								 <input type="text" class="form-control cust-required" name="TEL" id="TEL" value="<?= set_value('TEL'); ?>">
								 <small class="info help-block"> Tel must consist of 8 digits
								 </small>
							  </div>						  
						   </div>
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control cust-required" name="E_ADDR1" id="E_ADDR1" value="<?= set_value('E_ADDR1'); ?>">
								<small class="info help-block">
								</small>
							  </div>
