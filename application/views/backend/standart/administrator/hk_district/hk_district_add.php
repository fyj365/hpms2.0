...
<section class="content-header">
    <h1>
        Hk District        <small>New Hk District</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Hk District</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="REGION" id="REGION" placeholder="REGION" value="<?= set_value('REGION'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ENG_DISTRICT" id="ENG_DISTRICT" placeholder="ENG DISTRICT" value="<?= set_value('ENG_DISTRICT'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="CHI_DISTRICT" id="CHI_DISTRICT" placeholder="CHI DISTRICT" value="<?= set_value('CHI_DISTRICT'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/hk_district/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
