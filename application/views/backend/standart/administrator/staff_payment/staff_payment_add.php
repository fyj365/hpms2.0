...
<section class="content-header">
    <h1>
        Staff Payment        <small>New Staff Payment</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Staff Payment</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="STAFF_CODE" id="STAFF_CODE" placeholder="STAFF CODE" value="<?= set_value('STAFF_CODE'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/staff_payment/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
