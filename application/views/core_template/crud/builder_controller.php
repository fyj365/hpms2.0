...
if (!empty(${table_name}_<?= $file; ?>_name)) {
			...
			if ($save_{table_name}) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = 'Your data has been successfully stored into the database. '.anchor('administrator/{table_name}/edit/' . $save_{table_name}, 'Edit <?= ucwords(clean_snake_case($table_name)); ?>').' or  '.anchor('administrator/{table_name}', ' Go back to list');
				} else {
					set_message('Your data has been successfully stored into the database. '.anchor('administrator/{table_name}/edit/' . $save_{table_name}, 'Edit <?= ucwords(clean_snake_case($table_name)); ?>'), 'success');
